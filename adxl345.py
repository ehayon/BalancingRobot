# This code was taken from: https://github.com/adafruit/Adafruit-Raspberry-Pi-Python-Code/blob/master/Adafruit_ADXL345/Adafruit_ADXL345.py
from Adafruit_I2C import Adafruit_I2C


class ADXL345(Adafruit_I2C):
...
if __name__ == '__main__':
	...
	try:
		...
		pass
        #sleep(0.2) # Output is fun to watch if this is commented out